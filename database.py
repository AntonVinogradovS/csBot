...
async def add_user(user_id=0, referral_id = 0, skins_count=0, skins_received=0, friends_invited=0):
    cursor.execute('''
        INSERT INTO users (user_id, referral_id, skins_count, skins_received, friends_invited)
        VALUES (?, ?, ?, ?, ?)
    ''', (user_id, referral_id, skins_count, skins_received, friends_invited))
    conn.commit()
